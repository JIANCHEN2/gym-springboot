...
//                trainers.add(optional.get());
    ...
    public Flux<Trainer> queryAll() {
//        List<Trainer> trainers = null;
        Flux<Trainer> trainers = null;
